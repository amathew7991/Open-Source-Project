...
public class SbMenu {
	...
	private void setToolbar() {
		JButton[] btn = {
			...
			btNewPerson, btNewGender, btNewSpecies, btNewRelationship,//4
			btNewLocation,//1
			btNewItem, btNewItemlink,//2
			btNewTag, btNewTaglink, //2
			btMemo, btIdea, //2
			btTabStrand, btTabPart, btTabChapter, btTabScene,//4
			btTabPerson, btTabGender, btTabSpecies, btTabRelationship, //4
			btTabLocation, //1
	...
	private void initMenuTable() {
        ...
        tabSpecies = initMenuItem("16x32/manage_species","",' ',"species","tabSpecies");
