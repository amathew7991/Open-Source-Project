...
public class BookModel extends AbstractModel {
	...
	public synchronized void initEntites() {
		...
		// default species
		Species human = new Species(I18N.getMsg("person.species.human"), "Boring old hooman.");
	...
	// gender VICTORIA-CHECK This comment came in the original thing, but doesn't make much sense.
